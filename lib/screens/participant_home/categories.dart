...
class ParticipantCategories extends StatefulWidget {
  const ParticipantCategories({Key? key, required this.title})
      : super(key: key);
  final String title;

  @override
  State<ParticipantCategories> createState() => _ParticipantCategoriesState();
}

class _ParticipantCategoriesState extends State<ParticipantCategories> {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: SizedBox(
        ...
        child: Padding(
          ...
          child: Text(
            'Make the change for a better tomorrow',
